...
func main() {
	...
	// Generated file name and mock implementation type will be "Reader".
	// The generated file will also be placed in the "testdata/mock" folder.
	// If you want to change these defaults, use the AMock.GenerateAs() method.
